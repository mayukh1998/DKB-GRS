...
<script>alert('Issue Resolved Successfully');</script>
...
<div class="spltable">
    <table border-bottom="1" align="center" style="text-align: center;" class="myTable" id="myTable">
        ...
        <tbody>
            <%for (Issue li:list){if(li.getdepartment().toLowerCase().equals(s4.toLowerCase()) && li.getstatus().equals("assigned")){%>
            <tr>
                ...
                <td>
                    <form method="POST" action="actonissue" id="form1">

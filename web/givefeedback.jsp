...
{%>
<script> alert('Fill up the details');</script>
<%}else if(request.getParameter("m3") != null) {%>
<script> alert('Feedback Given Successfully... Not Satisfied. So Issue Reopened');</script>
            ...
            <form action="givefeedback">
                ...
                <div class="container22">
                    ...
                    <select name="issue_id" id="issue_id" onchange="getval()" required>
                        ...
                        <%for (Issue i:list){ if(i.getstatus().equals("resolved")){%>
                    ...
                    <p>
                        <small>
                            <i>Cannot find your issue.<a href="acquireissue.jsp" rel="nofollow"> Click here</a></i>
                        </small>
                    </p>
                    <br />
                    <br />
                    ...
                    <br />
                    <label class="radio-inline"> <input type="radio" name="feedback" value="1" />1 </label>
                    <label class="radio-inline"> <input type="radio" name="feedback" value="2" />2 </label>
                    <label class="radio-inline"> <input type="radio" name="feedback" value="3" />3 </label>
                    <label class="radio-inline">
                        <label class="radio-inline"> <input type="radio" name="feedback" value="4" />4 </label>
                        <input type="radio" name="feedback" value="5" checked />5
                    </label>
                    <br />
                    <p>
                        <small><i>*If Rating is less than 2, the issue will be reopened.</i></small>
                    </p>
                    <br />
